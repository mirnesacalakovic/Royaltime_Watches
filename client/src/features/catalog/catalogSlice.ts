...
function getAxiosParams(productParams: ProductParams) {
  ...
  if (productParams.models.length > 0)
    params.append("models", productParams.models.toString());
  if (productParams.genders.length > 0)
    params.append("genders", productParams.genders.toString());
...
export const catalogSlice = createSlice({
  ...
  reducers: {
    setProductParams: (state, action) => {
      ...
      console.log("catalog slice ", state.productParams);
    },
