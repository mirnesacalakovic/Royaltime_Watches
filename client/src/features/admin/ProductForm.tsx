        ...
        <Box component={Paper} sx={{p: 4}}>
            ...
            <Grid container spacing={3}>
                ...
                <Grid item xs={12} sm={6}>
                    <AppSelectList control={control} items={['Analogue', 'Digital']} name='type' label='Type' />
                </Grid>
                <Grid item xs={12} sm={6}>
                    <AppSelectList control={control} items={genders} name='gender' label='Gender' />
                </Grid>
                <Grid item xs={12} sm={12}>
                    <AppTextInput control={control} name='dialColor' label='Dial Color' />
                </Grid>
                <Grid item xs={12} sm={12}>
                    <AppTextInput control={control} name='strapType' label='Strap Type' />
                </Grid>
                <Grid item xs={12} sm={6}>
